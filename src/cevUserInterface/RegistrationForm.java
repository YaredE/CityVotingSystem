...
public class RegistrationForm extends JPanel  implements ActionListener {
	...
	public void actionPerformed(ActionEvent actionEvent) 
	{
		...
		else
		{
			...
			{
				Object obj = UIToDataLayerBridge.register (firstName,middleName,lastName,suffix,dateOfBirth, placeOfBirth,lastFourSSN, drivLic,emailAddress, streetAddress, city, zip , position, partyName);
